...
class AzureIoTHub
{
    ...
    //
    const string deviceConnectionString = "{ENTER CONNECTION STRING HERE}";
    ...
    public static async Task SendDeviceToCloudMessageAsync()
    {
        CreateClient();
#if WINDOWS_UWP
        var str = "{\"deviceId\":\"TestDevice\",\"messageId\":1,\"text\":\"Hello, Cloud from a UWP C# app!\"}";
#else
        var str = "{\"deviceId\":\"TestDevice\",\"messageId\":1,\"text\":\"Hello, Cloud from a C# app!\"}";
#endif
