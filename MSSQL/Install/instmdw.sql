...
SET @new_value = '14.0.1000.169'     -- This will be replaced at build time with the sql build number
...
BEGIN
    ...
    IF (@old_value_char <> '14.0.1000.169')   -- value only used during development
    BEGIN
